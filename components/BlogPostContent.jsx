    ...
    return(
        <div className="w-full md:w-2/3">
            <div className="w-full bg-white px-6 md:px-10 py-10 md:rounded-md">
                <h1 className="text-3xl xl:text-5xl text-black font-bold leading-normal xl:leading-tight tracking-tight">{props.post.title}</h1>
                <div className="flex gap-2 items-center mt-8">
                    ...
                    <p className="text-zinc-700 text-sm">{props.post.author.name}</p>
                    <p className="text-zinc-800 text-sm">|</p>
                    <p className="text-zinc-700 text-sm">{moment(props.post.updatedAt).format('DD MMM YYYY')}</p>
                </div>
